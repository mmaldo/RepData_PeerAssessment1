...
Data with with missing values is in blue. Red is imputed data. Plots of the other variables are just blue clusters since there is no missing data in any of them.
